...
VALUES ($1, $2, $3) RETURNING id, username, email, secret_code, is_used, created_at, expires_at
`
...
WHERE
    ...
    AND secret_code = $2
    AND is_used = FALSE
    AND expires_at > now() RETURNING id, username, email, secret_code, is_used, created_at, expires_at
`
